...
# Set Git identity
get_ipython().system('git config --global user.name "Erika Kelly"')
get_ipython().system('git config --global user.email "erika.l.dunn@gmail.com"')

# Clone your GitHub repo
get_ipython().system('git clone https://github.com/Erika-Dunn/IEP-RAG-IEP-Assistant.git')

# Change directory
get_ipython().run_line_magic('cd', 'IEP-RAG-IEP-Assistant')
...
get_ipython().system('pip install -q faiss-cpu sentence-transformers pdfplumber beautifulsoup4 requests')
...
get_ipython().system('pip install -q sentence-transformers faiss-cpu transformers accelerate')
